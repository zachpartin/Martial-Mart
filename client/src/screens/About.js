...
const About = () => {
  ...
  <div className="aboutPage">
      ...
      <p>There is very little that hardcore martial artists love than hoarding gear. If you find yourself with equipment that you aren't using anymore, sell it here and get yourself some money for it while giving someone else the opportunity to save money on gear that they need.</p>
        </div>
      <p>Github: https://github.com/zachpartin</p>
  </div>
  )
}
